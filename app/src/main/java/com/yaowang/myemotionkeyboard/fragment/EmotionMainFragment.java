...
import com.yaowang.myemotionkeyboard.adapter.HorizontalRecyclerviewAdapter;
import com.yaowang.myemotionkeyboard.adapter.NoHorizontalScrollerVPAdapter;
import com.yaowang.myemotionkeyboard.emotionkeyboardview.EmotionKeyboard;
import com.yaowang.myemotionkeyboard.emotionkeyboardview.NoHorizontalScrollerViewPager;
import com.yaowang.myemotionkeyboard.model.ImageModel;
...
import com.yaowang.myemotionkeyboard.utils.SharedPreferencedUtils;
...
public class EmotionMainFragment extends BaseFragment {
    ...
    private void replaceFragment(){
        ...
        FunctionComplateFragment f2 = (FunctionComplateFragment) factory.getFragment2(EmotionUtils.FUNCTION_CLASSIC_TYPE);
        fragments.add(f1);
        fragments.add(f2);
        Bundle b=null;
        for (int i=0;i<7;i++){
